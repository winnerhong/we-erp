        ...
        <div className="space-y-4 p-5">
          ...
          <div className="inline-flex rounded-lg border border-neutral-300 bg-white p-0.5 text-sm">
            <button
              ...
              className={`rounded-md px-3 py-1 font-medium ${inputMode === "import" ? "bg-indigo-500 text-white" : "text-neutral-500 hover:text-neutral-800"}`}
            >
              📂 파일·붙여넣기
            </button>
            <button
              onClick={switchToManual}
              className={`rounded-md px-3 py-1 font-medium ${inputMode === "manual" ? "bg-indigo-500 text-white" : "text-neutral-500 hover:text-neutral-800"}`}
            >
              ▦ 직접 입력(엑셀형)
            </button>
          </div>
